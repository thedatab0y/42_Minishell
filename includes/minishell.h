...
/*   Updated: 2023/05/19 19:26:08 by busmanov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct history	t_history;
...
int						ft_export_checker(char **args, t_env *env,
							t_env *secret);
...
void					squish_token(t_mini *mini, t_token *token,
							t_token *prev);
...
int						get_var_len(const char *arg, int pos, t_env *env,
							int ret);
